...
print("Dimensiones antes del filtrado:", adata.shape)

sc.pp.highly_variable_genes(
    adata,
    flavor="seurat_v3",     # Or "seurat", "cell_ranger", "seurat_v3" (most robbust)
    n_top_genes=2000
)

# 2. Filtrar tu AnnData para quedarte solo con esos genes (opcional)
adata_hvg = adata[:, adata.var['highly_variable']]

print("Dimensiones después del filtrado:", adata_hvg.shape)

print(adata_hvg)
adata_hvg.write("./data/adata_hvg2000.h5ad")
